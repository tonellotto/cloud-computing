...
|05/05|8:30-12:30|Online| Spark introduction: resilient distributed datasets, Lineage. Spark architecture: driver, executors, context.| [Slides](slides/spark-intro.pdf)<br>[Notes](notes/spark-installation-notes.md) |
