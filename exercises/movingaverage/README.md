...
More formally, let $A$ be a sequence of an ordered set of objects <img src="https://render.githubusercontent.com/render/math?math=A = (a_1, a_2, a_3, ..., a_n)"> . Then an $N$ moving average is a new sequence $s_i$ with i = 1, ...,  n − N + 1 from $a_i$ by taking
